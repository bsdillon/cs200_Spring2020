...
GoldField.prototype.GetLayer = function(id)
{
...
GoldField.prototype.AddGenericLayer = function(obj)
{
   obj.myID = this.layerCount++;
   this.layers[obj.myID]= obj;
   obj.Init(this.ctx);
}
...
Layer.prototype.Init = function(ctxobj)
{
  this.ctx = ctxobj;
  this.isOn = false;
}

Layer.prototype.SetLayerOn = function(turnOn)
{
  this.isOn = turnOn;
} 

Layer.prototype.DrawLayer = function(block)
{
  alert("default layer drawing");
}
/////////// End Layer /////////////////
